...
<html>
    <head>
        ...
        <%
            ...
            rs = manejador.executeQuery("SELECT titulo FROM oats WHERE id_oat='" + Id + "' ");
            while (rs.next()) {
                titulo = rs.getString("oats.titulo");
            }
        %>
        ...
        <div class="row well">
            <div class="col-md-6 col-md-offset-3">
                <div class="row">
                    ...
                    <h3 class="text-center">¿Seguro que desea eliminar el OAT <b> <%out.println(titulo);%></b>?</h3>
                    <s:form action="/DelOAT">
                        <input type="hidden" name="id" value=<%out.println(Id);%>/>
                        <input type="submit" value="Sí" class="btn btn-danger btn-block"/>
                        <a href="oats.jsp" class="btn btn-primary btn-block">Regresar</a>
                    </s:form>
                </div>
            </div>
        </div>
