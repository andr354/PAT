        ...
        <div class="container">
            <div class="row well">
                <div class="col-md-6 col-md-offset-3">
                    <div class="row">
                        <h1 class="text-center">Asignar grupo</h1>
                        <h3 class="text-center">Nuevo grupo para el Alumno: <b> <%out.println(nomcomp);%></b></h3><br>
                        <s:form action="/ModGrp" class="form-horizontal form-control">
                            <input type="hidden" name="id" value=<%out.println(Id);%>/>
                            Nuevo grupo: <input type="number" name="grupo"/><br><br>
