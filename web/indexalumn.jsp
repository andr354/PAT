                ...
                <div>
                    ...
                    <%
                        ...
                        while (rs2.next()) {
                            ...
                            out.println("<th>");
                            out.println("<a href='veroat2.jsp?id=" + rs2.getString("oats.id_oat") + "' class='btn btn-info btn-sm'>Ver OAT</a>");
                            out.println("<a href='comentar.jsp?id=" + rs2.getString("oats.id_oat") + "&ide=" + rs2.getInt("students.id_std") + "' class='btn btn-info btn-sm'>Enviar participación</a>");
                            out.println("</th>");
                            out.println("</tr>");
