...
public class Mail {
    ...
    public void enviarMail(String mensaje, String email, String asunto) {
        try {
            ...
            p.setProperty("mail.smtp.port.user", "richard.tellez91@gmail.com");
            ...
            message.setFrom(new InternetAddress("richard.tellez91@gmail.com"));
            ...
            t.connect("richard.tellez91@gmail.com", "AsusNexus7");
            //Se envia el correo
